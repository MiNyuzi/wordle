...
function appStart() {
  ...
  const displayGameover = () => {
    ...
    div.innerText = "게임 종료 됐습니다.";
    div.style =
      "display:flex; justify-content:center; align-items:center; position:absolute; top:40vh; left:40vw; background-color:white; height:43px;";
